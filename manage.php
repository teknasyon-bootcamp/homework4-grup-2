...
<form class="create_post" action="manage.php" method="POST" enctype="multipart/form-data">
    ...
    <button name="create" type="submit" class="btn btn-success">Ekle</button>
</form>
...
<form class="create_post" action="manage.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="img_input">
        <input type="file" class="form-control" id="image" name="image" required>
        <img src="img/posts/felsefeBilim.jpg" alt="">
    </div>
